...
public record AppealPeriodSearchCriteria(
        int page,
        int pageSize,
    ...
    public AppealPeriodSearchCriteria(int page, int pageSize, String evaluationYear,
                                      String collegeOrganizationCode, String departmentOrganizationCode,
                                      String activeYn, String keyword) {
        this(page, pageSize, evaluationYear, collegeOrganizationCode, departmentOrganizationCode, activeYn, keyword, null, false);
    }
