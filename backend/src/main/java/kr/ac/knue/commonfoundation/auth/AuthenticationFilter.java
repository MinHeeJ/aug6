...
import kr.ac.knue.commonfoundation.basic45.Basic45EvaluationBatchFoundationContract;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    private String pathToUiRoute(String apiPath) {
        ...
        String evaluationRuleBusinessRoute = EvaluationRuleBusinessFoundationContract.uiRouteForApiPath(apiPath);
        if (evaluationRuleBusinessRoute != null) {
            return evaluationRuleBusinessRoute;
        }
        ...
        String basic45Route = Basic45EvaluationBatchFoundationContract.uiRouteForApiPath(apiPath);
        if (basic45Route != null) {
            return basic45Route;
        }
