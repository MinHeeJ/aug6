...
public class EvaluationMaterialGenerationController {
    ...
    @GetMapping("/api/business/evaluation-material-generations/preview")
    public ApiResponse<EvaluationMaterialGenerationPreviewResponse> listEvaluationMaterialGenerationTargets(
        ...
        return ApiResponse.ok(service.preview(new EvaluationMaterialGenerationSearchCriteria(
