...
export const ADMIN_ROUTES: AdminRoute[] = [
  ...
  },
  {
    ...
    label: "공통 환경설정",
    screenId: "SCR-COMMON-SETTINGS-MGMT",
    menuPath: "시스템 관리 > 환경설정 관리 > 공통 환경설정",
  },
  {
    path: "/admin/evaluation-years",
    label: "기준연도 관리",
    screenId: "SCR-EVALUATION-YEAR-MGMT",
    menuPath: "시스템 관리 > 환경설정 관리 > 기준연도 관리",
  },
];
